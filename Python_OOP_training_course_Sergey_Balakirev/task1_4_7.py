...
class MotherBoard:
    ...
    def get_config(self):
        return [f'Материнская плата: {self.name}',
                ...
                f'Память: {"; ".join([f"{mem_slot.name} - {mem_slot.volume}" for mem_slot in self.mem_slots])}']


if __name__ == '__main__':
    cpu = CPU('Intel Core i7', 3333)
    mem1, mem2 = Memory('Kingstone', 32), Memory('Kingstone', 32)
