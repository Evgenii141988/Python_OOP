# Подвиг 10. Объявите в программе класс Video с двумя методами:
# create(self, name) - для создания нового видео с именем name (метод сохраняет имя name в локальном
